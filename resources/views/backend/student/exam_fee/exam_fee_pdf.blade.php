...
<h2 style="text-align:center;">Exam Fee Payslip - Student Copy</h2>
<h2 style="text-align:center;">For the Month: {{ $exam_type }}</h2>
...
<h2 style="text-align:center;">Exam Fee Payslip - Office Copy</h2>
<h2 style="text-align:center;">For the Month: {{ $exam_type }}</h2>
