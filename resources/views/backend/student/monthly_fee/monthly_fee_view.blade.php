                ...
                <div class="col-12">
                    <div class="box bb-3 border-warning">
                        <div class="box-header">
                            <h4 class="box-title">Monthly <strong>Fee</strong></h4>
                        </div>
                        ...
                        <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3"> <!-- Start Col-Md Row -->
                                        ...
                                        <div class="form-group">
                                            <h5>Month<span class="text-danger">*</span></h5>
                                                <select name="month" id="month" required class="custom-select custom-select-md">
                                    ...
                                    <div class="col-md-3 pt-25"> <!-- Start Col-Md Row -->
