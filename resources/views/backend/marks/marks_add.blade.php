                ...
                <div class="col-12">
                    <div class="box bb-3 border-warning">
                        <div class="box-header">
                            <h4 class="box-title">Student <strong>Marks </strong>Entry</h4>
                        </div>
                        ...
                        <div class="box-body">
                            <form action="{{ route('marks.entry.store') }}" method="post">
                                    ...
                                    <div class="col-md-3"> <!-- Start Col-Md Row -->
                                        ...
                                        <div class="form-group">
                                            <h5>Subject<span class="text-danger">*</span></h5>
                                                <select name="assign_subject_id" id="assign_subject_id" required class="custom-select custom-select-md">
                                                    <option selected="" >Select Subject</option>
                                                    <!-- by selecting class all the subject related assigned will be loaded using js -->
                                ...
                                <div class="row d-none" id="marks-entry"> <!-- d-none means not visible in the first load -->
                                    <div class="col-md-12">
