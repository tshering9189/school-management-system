                ...
                <div class="col-12">
                    <div class="box bb-3 border-warning">
                        <div class="box-header">
                            <h4 class="box-title">Manage <strong>MarkSheet </strong>PDF View</h4>
                        </div>
                        ...
                        <div class="box-body" style="border: solid 1px; padding: 10px;">
                            ...
                            <div class="row"> <!-- Start 1st Row -->
                                ...
                                <div class="col-md-12" style="float: right;">
                                    <img src="{{ url('upload/easyschool.png') }}" style="width: 120px;" alt="">
                                </div>
                                ...
                                <div class="col-md-12 text-center" style="float: left;">
                                    <h4><strong>Druk School</strong></h4>
                                    <h6><strong>Thimphu, Bhutan</strong></h6>
