                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <form novalidate="" method="post" action="{{ route('update.fee.amount',$editData[0]->fee_category_id) }}">
                            @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="add_item">
                                            ...
                                            </div><!-- For delete_whole_extra_item_add-->
                                            @endforeach
                                        </div> <!-- END add_item -->
                                    </div>

                                    <div class="text-xs-right">
                                        <input type="submit" class="btn btn-rounded btn-info mb-5" value="Update Fee Category">
                                    </div>
                                </div>
