    ...
    <!-- Main content -->
        ...
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title">Add Grade for Marks</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col">
                        ...
                        <form method="post" action="{{ route('store.marks.grades') }}">
                        @csrf
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="text-xs-right">
                                        <input type="submit" class="btn btn-rounded btn-info mb-5" value="Add Grade">
                                    </div>
                                </div>
