...
<aside class="main-sidebar">
            ...
            @if(Auth::user()->role=='Admin')    
                ...
                <a href="#">
                    <i data-feather="mail"></i> <span>Student Marks</span>
                    <span class="pull-right-container">
                    <i class="fa fa-angle-right pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'marks.entry.add') ? 'active' : '' }}"><a href="{{ route('marks.entry.add') }}"><i class="ti-more"></i>Entry Marks</a></li>
