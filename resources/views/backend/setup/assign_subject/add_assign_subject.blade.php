                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <form novalidate="" method="post" action="{{ route('store.assign.subject') }}">
                            @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="class_id" required class="custom-select">
                                ...
                                <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="subject_id[]" required class="custom-select custom-select-sm">
                                    ...
                                    <div class="text-xs-right">
                                        <input type="submit" class="btn btn-rounded btn-info mb-5" value="Add Assign Subject">
                                    </div>
                                </div>
